...
remaps.plugins = {
  ...
  setup = function()
    ...
    if ok then
      ...
      vim.keymap.set('n', '<leader>tc', function() builtin.lsp_code_actions() end, { desc = 'Telescope view available code actions' })
      ...
      -- vim.keymap.set('v', '<leader>tr', function() telescope.extensions.refactoring.refactors() end, { desc = '', noremap = true })
    end
